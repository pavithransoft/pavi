...
const Contact = () => {
  ...
  return (
    <section className="bg-slate-100 text-slate-900 pt-36 pb-16">
      <div className="w-3/4 m-auto grid grid-cols-2 gap-10">
        <div className="rounded overflow-hidden p-1 bg-white border">
          <iframe
            width="100%"
            height="100%"
            style={{ border: 0 }}
        ...
        <div className="bg-white border p-5 rounded">
          <h2 className="text-xl font-semibold pb-3">Get in Touch</h2>
          <p className="px-3">
