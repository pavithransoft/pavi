...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-slate-50">
      <section className="grid gap-8 sm:grid-cols-3 place-items-center sm:gap-16 py-8 sm:py-10 2xl:py-16">
        <div className="text-center order-3 sm:order-1">
          <h2 className="text-lg sm:text-xl 2xl:text-4xl font-medium py-1">
            Location
          </h2>
          <p className="py-1 text-sm sm:text-base 2xl:text-3xl text-slate-300 leading-relaxed sm:leading-relaxed">
            Plot No. 4, Saravana Nagar, <br />
        ...
        <div className="text-center order-2">
          ...
          <div className="flex justify-center gap-4 py-2 text-slate-500">
            <FaLinkedinIn className="h-5 w-5 sm:h-6 sm:w-6 2xl:h-9 2xl:w-9 cursor-pointer" />
            <FaGithub className="h-5 w-5 sm:h-6 sm:w-6 2xl:h-9 2xl:w-9 cursor-pointer" />
          </div>
        </div>
        <div className="text-center order-1 sm:order-3">
          ...
          <p className="py-1 text-sm sm:text-base 2xl:text-3xl leading-relaxed sm:leading-relaxed text-slate-300">
            pavithran.soft@gmail.com <br />
            +91 8012322922
          </p>
        </div>
