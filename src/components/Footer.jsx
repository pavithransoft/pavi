...
const Footer = () => {
  return (
    <footer className="bg-slate-900 text-slate-50">
      <section className="grid gap-8 sm:grid-cols-3 place-items-center py-8 xl:py-10 px-3">
      ...
      <p className="flex items-center justify-center gap-1 font-thin text-xs xl:text-sm p-5 text-center">
